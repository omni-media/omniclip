...
export const timeline_state: Timeline = {
	...
	clips: [
		...
		{id: generate_id(),item: {type: "Text", content: "", color: "", size: 4},
			start: 70, end: 120, track: 0, start_at_position: 0, length: 50
		},
		{id: generate_id(),item: {type: "Video", source: ""},
			start: 0, end: 60, track: 0, start_at_position: 50, length: 60
		},
		{id: generate_id(),item: {type: "Image", source: ""},
			start: 200, end: 300, track: 0, start_at_position: 200, length: 100
		},
		{id: generate_id(),item: {type: "Video", source: ""},
			start: 400, end: 450, track: 0, start_at_position: 350, length: 50
		}
	]
}
